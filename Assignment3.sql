...
-- Q1 : Write a query that produces all rows from the Customers table for which the salesperson’s number is 1001

-- SELECT * FROM customers where snum=1001;


-- Q2 :  Write a select command that produces the rating followed by the name of each customer in San Jose
-- SELECT cname,rating FROM customers WHERE city='San Jose';

-- Q3 : Write a query that will produce the snum values of all salespeople from the Orders table (with the duplicate values suppressed)
