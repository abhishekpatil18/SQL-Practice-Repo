...
-- Q9 : Display details of the employees where commission percentage is null and salary in the range 5000 to 10000 and department is 30.
...
-- WE can Do this also using JOINS
SELECT e.FIRST_NAME,e.EMAIL FROM employees e 
...
SELECT * FROM employees WHERE JOB_ID='IT_PROG' AND JOB_ID='FIACCOUNT';
